 ...
 * for example: if the APP_ENV is staging, the bundle id will be com.affwa.staging
 */

// TODO: Replace these values with your own

const BUNDLE_ID = 'com.affwa'; // ios bundle id
const PACKAGE = 'com.affwa'; // android package name
const NAME = 'affwa'; // app name
const EXPO_ACCOUNT_OWNER = 'divineleo2001-org'; // expo account owner
const EAS_PROJECT_ID = '36cbc827-c522-4b0a-a988-2fdf7edf1824'; // eas project id
const SCHEME = 'affwa'; // app scheme
